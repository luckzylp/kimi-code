...
/**
 * Local type for the kernel-native MCP server config. Defined here so
 * the v2 package has no direct dependency on `@moonshot-ai/agent-core` (v1).
 * The shape matches both v1 and v2 kernel definitions.
 */
